...
The 'nativo_migration' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/nativo_migration/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] nativo_migration_etl` to your workspace.
